...
/*	private static  String servicePath = "tkh-dig-domain";
	...
	//科室诊断模板删除
	public  static final String deletFavoriteDept="http://"+servicePath+"/digdomain/deleteFavoriteDept";
	//个人诊断模板新增
	...
	//诊断状态更新
	public  static final String updateEncounterStatus="http://"+servicePath+"/digdomain/updateEncounterStatus";
	//诊断列表上移下移
	public  static final String updateSortOrder="http://"+servicePath+"/digdomain/updateSortOrder";
